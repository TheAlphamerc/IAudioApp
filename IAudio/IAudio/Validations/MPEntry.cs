    ...
    public class MPEntry : Entry
    {
        ...
        private void SetPlaceHolder()
        {
            if (!string.IsNullOrEmpty(BindingPath) && this.BindingContext != null)
            {
                ...
                if (_attributes != null)
                {
                    this.Placeholder = _attributes.Name;
                    //this.PlaceholderColor = Color.Gray;// assign placeholder property
                }
            }
        }
        ...
        public static readonly BindableProperty PlaceholderTextColorProperty =
           BindableProperty.Create("PlaceholderTextColor", typeof(Color), typeof(MPEntry), Color.Default);
